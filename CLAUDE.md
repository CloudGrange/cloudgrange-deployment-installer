# CLAUDE.md — cloudsmith-installer

Claude Code context for `cloudsmith-installer` — one of the code repos in the CloudSmith open-source project.
...
_(no detected build commands — see repo README)_
...
- `cloudsmith-installer-engineer` (model: sonnet) — cloudsmith-installer PowerShell engineer — scripts, modules, PSScriptAnalyzer, Pester tests
