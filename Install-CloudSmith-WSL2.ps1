...
#
# This script is the standalone entry point for deploying CloudSmith via the
# WSL2 fallback path. It is equivalent to running:
#   Install-CloudSmith.ps1 -Mode WSL2
#
...
Write-Host ""
Write-Host "  CloudSmith Installer — Mode: WSL2 (dev/lab)" -ForegroundColor Cyan
...
Write-Host ""
Write-Host "  CloudSmith deployed (WSL2 mode)." -ForegroundColor Green
...
Write-Host "  For production, use: .\Install-CloudSmith.ps1 -Mode Online" -ForegroundColor Yellow
Write-Host ""
